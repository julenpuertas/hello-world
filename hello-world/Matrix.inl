...
namespace Engine
{
	namespace Math
	{
		...
		template <typename T> template <typename U, glm::precision P> Matrix<T, 3, 3>::Matrix(glm::tmat3x3<U, P>&& rhs)
			: ExtendedGLMMatrix<Engine::Math::Matrix, T, 3, 3, glm::tmat3x3>(std::forward<glm::tmat3x3<U, P> >(rhs))
		{}

		template <typename T> template <typename ... Args> Matrix<T, 3, 4>::Matrix(Args&& ... args)
			: ExtendedGLMMatrix<Engine::Math::Matrix, T, 3, 3, glm::tmat4x3>(std::forward<Args>(args)...)
		{}

		template <typename T> template <typename U, glm::precision P> Matrix<T, 3, 4>::Matrix(glm::tmat4x3<U, P>&& rhs)
			: ExtendedGLMMatrix<Engine::Math::Matrix, T, 3, 3, glm::tmat4x3>(std::forward<glm::tmat4x3<U, P> >(rhs))
		{}
