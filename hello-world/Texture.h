...
namespace Engine
{
	namespace Graphics
	{
		...
		private:
			static ID::Provider g_id_provider;
			GLuint handle_ = 0;
			ID location_{ g_id_provider, ID::INVALID };
		...
		public:
			...
			SVector2 get_size(size_t mipmap_level = 0) const;
			...
			Math::Vector<Wrap, 2> get_wrap() const;
			void set_wrap(const Math::Vector<Wrap, 2>& wrap) const;
